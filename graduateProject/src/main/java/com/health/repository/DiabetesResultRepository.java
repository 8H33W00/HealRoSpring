...
public interface DiabetesResultRepository extends JpaRepository<DiabetesResult,String>{
	...
	void recordResultDiabete(@Param("odd")Float odd, @Param("userName")String userName, @Param("date")String date);
	...
	@Query(value = "UPDATE diabetes_result A"
			...
			+" WHERE A.USER_NAME = (:userName)",nativeQuery = true)
	void recordResultDiabetePast(@Param("odd")Float odd, @Param("userName")String userName, @Param("date")String date);
}
